...
class update_video(LoginRequiredMixin, UserPassesTestMixin,UpdateView):
    model = Video
...
class delete_video(LoginRequiredMixin, UserPassesTestMixin,DeleteView):
    model = Video
